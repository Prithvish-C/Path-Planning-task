...
class MapNode:
    def __init__(self):
        ...
        f = open("C:\\Users\\prithvish\\OneDrive\\Desktop\\Robocon Task\\Recruitment-24\\Path_Planning\\map1.txt", "r") # change this location to the location of map1.txt on your device.
